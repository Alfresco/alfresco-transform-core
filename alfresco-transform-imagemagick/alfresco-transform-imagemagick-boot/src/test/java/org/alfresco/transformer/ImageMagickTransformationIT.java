...
public class ImageMagickTransformationIT
{
    ...
    private static final Map<String, TestFileInfo> TEST_FILES = Stream.of(
        ...
        testFile(MIMETYPE_IMAGE_RAW_X3F,"x3f","quick.x3f"),
        testFile(MIMETYPE_IMAGE_TIFF,"tiff","quick.tiff"),
        testFile(MIMETYPE_IMAGE_RAW_RWL,"rwl","quick.rwl"),
        testFile(MIMETYPE_IMAGE_RAW_RW2,"rw2","quick.rw2"),
        testFile(MIMETYPE_IMAGE_RAS,"ras","quick.ras"),
        testFile(MIMETYPE_IMAGE_RAW_RAF,"raf","quick.raf"),
        testFile(MIMETYPE_IMAGE_RAW_R3D,"r3d","quick.r3d"),
        testFile(MIMETYPE_IMAGE_PSD,"psd","quick.psd"),
        testFile(MIMETYPE_IMAGE_PPJ,"ppj","quick.ppj"),
        ...
        testFile(MIMETYPE_IMAGE_RAW_MRW,"mrw","quick.mrw"),
        testFile(MIMETYPE_IMAGE_RAW_K25,"k25","quick.k25"),
        testFile(MIMETYPE_IMAGE_JP2,"jp2","quick.jp2"),
        testFile(MIMETYPE_IMAGE_IEF,"ief","quick.ief"),
        testFile(MIMETYPE_IMAGE_RAW_DNG,"dng","quick.dng"),
        testFile(MIMETYPE_IMAGE_RAW_CR2,"cr2","quick.cr2"),
        testFile(MIMETYPE_IMAGE_RAW_ARW,"arw","quick.arw"),
        testFile(MIMETYPE_IMAGE_RAW_3FR,"3fr","quick.3fr"),
